...
const FAQ: React.FC = () => {
  ...
  const questions = [
    {
      q: "O ZapElite causa banimento do meu número?",
    ...
    },
    {
      ...
      a: "Não! O ZapElite é 100% online (SaaS). Você acessa pelo seu navegador de qualquer lugar do mundo, sem precisar instalar nada pesado no seu PC."
    },
    {
    ...
    },
    {
      ...
      a: "Com certeza. Temos integração via Webhooks e API REST que permite conectar o ZapElite a Hotmart, Kiwify, ActiveCampaign, e qualquer outra ferramenta que suporte webhooks."
    },
    {
