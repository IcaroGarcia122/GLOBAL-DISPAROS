      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {plaques.map((plaque, idx) => (
            <div key={idx} className={`bg-[#0b1121] p-3 rounded-[3.5rem] border ${plaque.color} transition-all duration-700 hover:-translate-y-6 group cursor-pointer shadow-2xl`}>
